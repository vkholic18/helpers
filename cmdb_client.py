...
class CMDBClient:
    ...
    @staticmethod
    def build_cmdb_payload(
        missing_ips_list: List[Dict[str, str]],
    ) -> dict[str, list[Any]]:
        records = []
        ...
        for record in missing_ips_list:
            ...
            payload_record = {
                ...
                "u_serial_number": record.get("serial_number", ""),
                "u_emergency_contacts": record.get("emergency_contacts", ""),
                "u_exclude_patching": record.get("u_exclude_patching", False),
                "u_exclude_anti_virus": record.get("u_exclude_anti_virus", False),
                "u_exclude_health_checks": record.get("u_exclude_health_checks", False),
                "u_exclude_log_collections": record.get(
                    "u_exclude_log_collections", False
                ),
                "u_exclude_reason": record.get("u_exclude_reason", ""),
            }
